...
String Page_config(){
  return("<!DOCTYPE html>\
        ...
        .form{\
          ...
          <body>\
            <form id=\"conf\" class=\"form\" action=\"/set_configuration\" method=\"get\">\
              ...
              <input type=\"text\" name=\"delay\" placeholder=\"Delay to motor\" form=\"conf\"><br><br>\
              <input type=\"submit\" class=\"btn\" value=\"Set\" form=\"conf\">\
            </form>\
            <br>\
            <form id=\"conf_btn\" class=\"form\">\
              <input type=\"button\" value=\"1 поворот вперед\" class=\"btn\" onclick=\"location.href=\'/1_frwd\'\"><br><br>\
              <input type=\"button\" value=\"1 поворот назад\" class=\"btn\" onclick=\"location.href=\'/1_back\'\"><br><br>\
              <input type=\"button\" value=\"Домой\" class=\"btn\" onclick=\"location.href=\'/\'\"><br>\
            </form>\
          </body>\
        </html>");
  }
...
String Page_home(){
  ...
  <html>\
    ...
    <body>\
    <\div \class=\"form\">\
      <input type=\"button\" value=\"Настройки\" class=\"btn\" onclick=\"location.href=\'/config\'\"><br>\
